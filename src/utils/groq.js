...
export async function analyzeContent(text, apiKey) {
  const prompt = `You are a learning path expert. Analyze the following text and extract 15-20 key concepts/terms that someone should learn to understand it fully.
